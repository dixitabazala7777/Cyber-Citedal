...
export const MitreMatrix: React.FC<MitreMatrixProps> = ({ 
  ...
  return (
    <div id="mitre-matrix-module" className="relative p-6 bg-white dark:bg-[#161b22] border border-slate-200 dark:border-[#30363d] rounded-xl shadow-xs dark:shadow-sm overflow-hidden min-h-[500px]">
                  ...
                  {selectedTechnique.mappedIncidents.length === 0 ? (
                    ...
                    <div className="space-y-2 max-h-[220px] overflow-y-auto">
                      {selectedTechnique.mappedIncidents.map((inc) => (
                        <div key={inc.id} className="p-3 bg-[#090c10] border border-slate-900 rounded-lg flex flex-col gap-2">
