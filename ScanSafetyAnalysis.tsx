...
export const ScanSafetyAnalysis: React.FC<ScanSafetyAnalysisProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-[#161b22] border border-slate-800 rounded-xl overflow-hidden shadow-sm relative">
        ...
        <div className="p-5 md:p-6">
          <AnimatePresence mode="wait">
            ...
            {!isScanning && !analysis && (
              ...
              >
                <div className="p-3.5 bg-slate-900 border border-[#30363d] rounded-xl">
