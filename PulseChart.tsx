          ...
          <AreaChart data={getFilteredData()} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            <defs>
              ...
              <linearGradient id="colorBlockedDark" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#da3633" stopOpacity={0.35}/>
                <stop offset="95%" stopColor="#da3633" stopOpacity={0}/>
              </linearGradient>
            </defs>
            <CartesianGrid strokeDasharray="3 3" stroke="#8b949e" strokeOpacity={0.15} />
            <XAxis dataKey="time" stroke="#8b949e" fontSize={10} tickLine={false} />
            <YAxis stroke="#8b949e" fontSize={10} tickLine={false} axisLine={false} />
            <Tooltip content={<CustomTooltip />} cursor={{ stroke: '#8b949e', strokeWidth: 1, strokeDasharray: '4 4' }} />
            {showTraffic && (
              <Area
                type="monotone"
                dataKey="traffic"
            ...
            {showThreats && (
              <Area
                ...
                name="Threats Found"
                activeDot={<CustomActiveDot stroke="#d29922" />}
                isAnimationActive={true}
                animationDuration={750}
              />
            )}
            {showBlocked && (
              <Area
                ...
                activeDot={<CustomActiveDot stroke="#da3633" />}
                isAnimationActive={true}
                animationDuration={750}
              />
            )}
