    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-950 border border-slate-900 rounded-2xl p-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 relative z-10">
          ...
          {/* Quick Stats Pill */}
          <div className="flex items-center gap-3 bg-[#090c10] border border-slate-800 px-4 py-2 rounded-xl font-mono text-xs">
            ...
            <div className="bg-slate-950 border border-slate-900 rounded-2xl p-5 space-y-4 shadow-xl">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-[#090c10] border border-slate-800 rounded-xl p-3.5 text-xs text-slate-200 font-mono focus:outline-none focus:border-indigo-500 shadow-inner"
            ...
            {pipelineOutput && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                  <div className="bg-[#090c10] border border-slate-900 p-3 rounded-xl space-y-1">
                ...
                <div className="bg-[#090c10] border border-slate-800 p-4 rounded-xl space-y-1">
                ...
                <div className="bg-slate-950 border border-slate-900 rounded-2xl p-6 space-y-6 shadow-2xl">
                  ...
                  <div className="space-y-2 font-mono text-xs">
                    ...
                    <input 
                      ...
                      className="w-full bg-[#090c10] border border-slate-800 rounded-xl p-3 text-xs text-slate-200 focus:outline-none focus:border-cyan-500"
                    />
                  </div>
                  ...
                  {layerTestOutput && (
                    <motion.div 
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      className="bg-[#090c10] border border-slate-800 rounded-xl p-4 space-y-3 font-mono text-xs"
                    >
              ...
              {testResults && !isTesting && (
                <div className="space-y-4">
                  ...
                  <div className="border border-slate-900 rounded-xl overflow-hidden font-mono text-xs">
                    ...
                    <div className="divide-y divide-slate-900/60 bg-[#090c10]/50">
