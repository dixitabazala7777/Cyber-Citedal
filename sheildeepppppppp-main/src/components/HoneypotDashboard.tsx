...
export const HoneypotDashboard: React.FC<HoneypotDashboardProps> = ({ isLockdownActive = false, onLogMessage, onBlockIp }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-[#0d0d11]/80 backdrop-blur-md border border-white/10 ring-1 ring-white/5 rounded-2xl p-5 gap-4">
        <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Metric 1 */}
        <div className="bg-[#0d0d11]/80 backdrop-blur-md border border-white/10 ring-1 ring-white/5 p-5 rounded-2xl flex items-center justify-between shadow-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        {sensors.map((sensor) => (
          <div key={sensor.id} className="bg-[#0d0d11]/80 backdrop-blur-md border border-white/10 ring-1 ring-white/5 rounded-2xl p-5 space-y-4 hover:border-white/20 transition-all duration-200 shadow-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[#0d0d11]/80 backdrop-blur-md border border-white/10 ring-1 ring-white/5 p-6 rounded-2xl shadow-2xl flex flex-col h-[340px]">
          ...
          <div className="flex-1 w-full text-xs">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={analytics.topTargetedPorts}>
                ...
                <Tooltip
                  contentStyle={{ backgroundColor: '#121218', borderColor: 'rgba(255,255,255,0.1)', color: '#ffffff', fontFamily: 'monospace' }}
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Tooltip
                  contentStyle={{ backgroundColor: '#121218', borderColor: 'rgba(255,255,255,0.1)', color: '#ffffff', fontFamily: 'monospace' }}
                />
                <Legend layout="horizontal" verticalAlign="bottom" align="center" wrapperStyle={{ fontFamily: 'monospace', fontSize: '10px', color: '#a1a1aa' }} />
              </PieChart>
            </ResponsiveContainer>
          </div>
        </div>
      ...
      <div className="bg-[#0d0d11]/80 backdrop-blur-md border border-white/10 ring-1 ring-white/5 rounded-2xl p-6 shadow-2xl space-y-4">
        ...
        {showBlockModal && (
          <div className="fixed inset-0 bg-black/85 backdrop-blur-md flex items-center justify-center z-50 p-4">
            <motion.div
              ...
              className="bg-[#0d0d11] border border-white/10 ring-1 ring-white/10 rounded-2xl w-full max-w-md p-6 relative shadow-2xl space-y-4"
            >
              <button
