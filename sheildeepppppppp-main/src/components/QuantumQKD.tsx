...
export const QuantumQKD: React.FC<QuantumQKDProps> = () => {
  return (
    <motion.div
      ...
      className="space-y-6"
    >
      <div className="bg-[#0F172A] border border-[#334155] rounded-xl p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {PQ_ALGORITHMS.map((algo) => (
            <div 
              key={algo.name}
              className="bg-[#1E293B]/70 border border-[#334155] rounded-lg p-4 hover:border-slate-500 transition-colors"
            >
