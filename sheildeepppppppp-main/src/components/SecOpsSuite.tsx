...
export const SecOpsSuite: React.FC<SecOpsSuiteProps> = ({
  ...
  return (
    <div id="secops-suite-container" className="max-w-7xl w-full mx-auto px-4 mt-6 relative z-10 flex flex-col gap-5">
      ...
      {/* Sub Navigation Bar */}
      <div className="bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-[#334155] rounded-xl p-2.5 flex flex-col md:flex-row justify-between items-center gap-3 shadow-xs dark:shadow-sm">
