  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 max-w-7xl w-full mx-auto p-4">
      ...
      <motion.div className="lg:col-span-2 space-y-5" variants={tabItemVariants}>
        <div className="bg-[#050b18]/60 backdrop-blur-xl border border-slate-800/80 rounded-xl p-5 shadow-lg space-y-4 hover:border-slate-700/60 transition duration-300 relative group overflow-hidden">
                    ...
                    <div className="relative flex items-center justify-center w-7 h-7">
                      <svg className="w-7 h-7 transform -rotate-90">
                        ...
                        <circle
                          ...
                          cy="14"
                          r="11"
                          stroke={tunnel.status === 'rekeying' ? '#22d3ee' : '#10b981'}
                          strokeWidth="2"
                          fill="transparent"
      ...
      <motion.div className="space-y-5" variants={tabItemVariants}>
        <div className="bg-[#050b18]/60 backdrop-blur-xl border border-slate-800/80 rounded-xl p-5 shadow-lg flex flex-col justify-between min-h-[360px] hover:border-slate-700/60 transition duration-300 relative group overflow-hidden">
          <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-cyan-500/10 to-transparent group-hover:via-cyan-500/30 transition-all duration-1000" />
