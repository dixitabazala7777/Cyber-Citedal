...
export const KillChainTimeline: React.FC<KillChainTimelineProps> = ({ incidents, onLogMessage }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-[#334155] rounded-xl p-5 shadow-xs dark:shadow-sm">
      {/* Header */}
                ...
                <button
                  ...
                  className={`flex-1 px-4 py-3 rounded-lg border text-left transition-all cursor-pointer ${
                    isActive
                      ...
                      : 'bg-slate-50 dark:bg-[#030712] border-slate-200 dark:border-[#334155] hover:border-slate-300 dark:hover:border-slate-600'
                  }`}
                >
