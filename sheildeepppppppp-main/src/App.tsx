...
export default function App() {
  ...
  const [theme, setTheme] = useState<'light' | 'dark'>(() => {
    const saved = localStorage.getItem('deepshield-theme');
            ...
            <main className="max-w-7xl w-full mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-6 flex flex-col">
                ...
                <motion.div 
                  ...
                  className="bg-[#0F172A] border border-[#334155] rounded-xl p-4 font-mono text-xs shadow-sm flex-1 min-h-[160px] flex flex-col justify-between"
                >
                  <div>
