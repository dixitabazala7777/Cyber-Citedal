      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-full max-w-md bg-white/98 dark:bg-[#090c10]/95 border-l border-slate-200 dark:border-slate-800/80 shadow-2xl dark:shadow-[0_0_50px_rgba(0,0,0,0.8)] z-50 flex flex-col font-sans"
          >
            ...
            {/* Drawer Header */}
            <div className="p-5 border-b border-slate-200 dark:border-slate-900 flex justify-between items-center bg-slate-50 dark:bg-[#090c10]/80 mt-[2px]">
              <div className="flex items-center gap-2">
                <div className="relative">
                  <Bell className="w-5 h-5 text-sky-600 dark:text-cyan-400 animate-pulse" />
                  {pinnedAlertIds.length > 0 && (
                    <span className="absolute -top-1.5 -right-1.5 bg-sky-500 dark:bg-cyan-500 text-white dark:text-slate-950 text-[9px] font-extrabold w-4 h-4 rounded-full flex items-center justify-center border border-white dark:border-[#090c10]">
            ...
            <div className="p-4 bg-slate-50 dark:bg-[#090c10]/40 border-b border-slate-200 dark:border-slate-900 space-y-3">
              {/* Search */}
              <div className="relative">
                  ...
                  {filteredAlerts.map((alert) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={`bg-slate-50 dark:bg-[#090c10]/60 hover:bg-slate-100 dark:hover:bg-[#0d1117]/80 border ${
                          isPinned 
